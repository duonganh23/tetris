...
class Game:
    def __init__(self, get_next_shape, update_score):
        ...
        #test tetromino
        self.field_data = [[0 for x in range(COLUMNS)] for i in range(ROWS)]
    ...
    def create_new_tetromino(self):
        ...
        for block in self.tetromino.blocks:
            ...
            if 0 <= y < ROWS and self.field_data[y][x]:
                self.game_over = True
                break
...
class Block(pygame.sprite.Sprite):
    def __init__(self, group, pos, color):
        ...
        #pos
        self.pos = pygame.Vector2(pos) + BLOCK_OFF_SET
